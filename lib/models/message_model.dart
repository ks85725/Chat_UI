...
class Message {
  final User sender;
  final String text;
  final String time; //time is use for firebase
  final bool isLiked;
  final bool unread;
...
final User currentUser =
    User(id: 0, name: 'Cuurent User', imageUrl: 'assets/images/greg.jpg');
...
List<Message> chats = [
  Message(
    sender: james,
    time: '5:30 PM',
    text: 'Hey, how\'s it going? What did you do today jnnjds smd jknd csd jdsn as jsadnc asd,a  jkasnjnadamskndias laknsdinaskdnasnd hnsuuanfkcnnasnfkjasn kabwsudakmsb?',
    isLiked: false,
    unread: true,
  ),
  Message(
